...
namespace Unity.Multiplayer.PlayMode.Configurations.Editor.Gui
{
    internal class PlayModeButtonsView : UxmlView<PlayModeButtonsView>
    {
        ...
        void OnEditorChangedPlaymodeState(PlayModeStateChange playModeStateChange)
        {
            if (playModeStateChange == PlayModeStateChange.EnteredPlayMode)
            {
                EditorApplication.delayCall += () =>
                {
                    ...
                    if (PlayModeManager.instance.CurrentState != PlayModeState.Running &&
                        PlayModeManager.instance.ActivePlayModeConfig.GetType() != typeof(DefaultPlayModeConfig))
                    {
                        Debug.LogWarning(
            ...
            if (playModeStateChange == PlayModeStateChange.ExitingPlayMode)
            {
                ...
                EditorApplication.delayCall += () =>
                {
                    ...
                    if (!EditorApplication.isPlayingOrWillChangePlaymode && PlayModeManager.instance.CurrentState == PlayModeState.Running)
                    {
        ...
        private void OnConfigAssetChanged()
        {
            ...
            m_StepButton.SetEnabled(PlayModeManager.instance.SupportsPauseAndStep && (PlayModeManager.instance.CurrentState == PlayModeState.Running || EditorApplication.isPlaying));
        }
